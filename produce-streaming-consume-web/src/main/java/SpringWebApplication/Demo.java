...
public class Demo {
	...
	public static void runDemo(String intputTopic, String outputTopic) throws InterruptedException {
		...
		KafkaProducerRunner ProducerRunner1 = new KafkaProducerRunner(props, intputTopic, "Colorado_20170708.csv");
		KafkaProducerRunner ProducerRunner2 = new KafkaProducerRunner(props, intputTopic, "Manhattan_20170708.csv");
		KafkaProducerRunner ProducerRunner3 = new KafkaProducerRunner(props, intputTopic, "Oregon_20170708.csv");
